...
$post_comments=mysqli_num_rows($select_all_comment);
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php 
             ...
             $elements_count=[$post_count,$post_published_count,$post_draft_count,$post_comments,$unapproved_comment_count,$users_count,$subscriber_count,$post_categories];
