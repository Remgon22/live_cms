     ...
     <!-- Navigation -->
       <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                         <ul class="nav navbar-right top-nav">
                         <li> <a href="../index.php">Users Online:<?php echo "12";?></a> </li> 
                   <!-- <li> <a href="../index.php">Users Online:<span class="usersOnline"></span>
                </a> </li> !-->
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="../index.php"><i class="fa fa-dashboard"></i> Go back to home</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="../admin/profile.php"><i class="fa fa-fw fa-info"></i> Profile</a>
                    </li>
